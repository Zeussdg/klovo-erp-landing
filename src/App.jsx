...
const DepotStockPage = lazy(() => import("./pages/products/DepotStockPage"));
...
const EDonusumPage = lazy(() => import("./pages/products/EDonusumPage"));

const FinancePage = lazy(() => import("./pages/products/FinancePage"));
...
const PerakendePage = lazy(() => import("./pages/products/PerakendePage"));

const AkaryakitPage = lazy(() => import("./pages/products/AkaryakitPage"));
...
const UretimPage = lazy(() => import("./pages/products/UretimPage"));
          ...
          <div className="container">
            ...
            <div className="demo-wrapper">
              <div className="demo-preview">
                <Suspense
                  fallback={
                    <div className="demo-loading">Demo yükleniyor…</div>
                  }
                >
                  {activeDevice === "phone" ? (
              ...
              <div className="download-card">
                ...
                <p>
                  Telefonunuzla QR kodu tarayın. Cihazınıza uygun uygulama
                  mağazasına otomatik olarak yönlendirilirsiniz.
                </p>
              </div>
            </div>
          </div>
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          path="/products/restoran-cafe"
          element={<RestaurantCafePage />}
        />
        <Route
          path="/products/hizmet-yonetimi"
          element={<HizmetYonetimiPage />}
        />
        <Route path="/products/perakende" element={<PerakendePage />} />
        <Route path="/products/akaryakit" element={<AkaryakitPage />} />
        <Route
          path="/products/personel-yonetimi"
          element={<PersonelYonetimiPage />}
        />
        <Route path="/products/Uretim" element={<UretimPage />} />
      </Routes>
    </BrowserRouter>
  );
}
